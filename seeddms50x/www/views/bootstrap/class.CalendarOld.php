 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_CalendarOld extends SeedDMS_Bootstrap_Style {
	...
	function getMonthHTML($calendar, $month, $year) { /* {{{ */
		...
		$s .= "<tr>\n";
		$s .= "<td style=\"border-top: 0px;\" colspan=\"7\"><a href=\"../out/out.CalendarOld.php?mode=m&year=".$year."&month=".$month."\">".$monthName."</a></td>\n"; ;
		$s .= "</tr>\n";
		...
		$events = $calendar->getEventsInInterval(mktime(0,0,0, $month, 1, $year), mktime(23,59,59, $month+1, 0, $year));
		$eventdays = array();
		if($events) {
		...
		while ($d <= $daysInMonth)
		{
			...
			for ($i = 0; $i < 7; $i++){
				...
				if ($d > 0 && $d <= $daysInMonth){
					...
					$s .= "<a href=\"../out/out.CalendarOld.php?mode=w&year=".$year."&month=".$month."&day=".$d."\">".$d."</a>";
							}
				else $s .= "&nbsp;";
	...
	function printYearTable($calendar, $year) { /* {{{ */
		print "<table class=\"table\" style=\"max-width: 700px;\">\n";
		print "<tr>";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 1 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 2 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 3 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 4 , $year) ."</td>\n";
		print "</tr>\n";
		print "<tr>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 5 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 6 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 7 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 8 , $year) ."</td>\n";
		print "</tr>\n";
		print "<tr>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 9 , $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 10, $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 11, $year) ."</td>\n";
		print "<td valign=\"top\">" . $this->getMonthHTML($calendar, 12, $year) ."</td>\n";
		print "</tr>\n";
		print "</table>\n";
	} /* }}} */
	...
	function show() { /* {{{ */
		...
		$this->contentStart();
		$this->pageNavigation("", "calendarold",array($day,$month,$year));
		...
		if ($mode=="y"){
			...
			echo "<ul>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=y&year=".($year-1)."\"><i style=\"color: black;\" class=\"icon-arrow-left\"></i></a></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=y\"><i style=\"color: black;\" class=\"icon-circle-blank\"></i></a></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=y&year=".($year+1)."\"><i style=\"color: black;\" class=\"icon-arrow-right\"></i></a></li>";
			echo "</ul>";
			echo "</div>";

//			$this->contentContainerStart();
			$this->printYearTable($calendar, $year);
//			$this->contentContainerEnd();
			...
			echo "<div class=\"pagination pagination-small\">";
			echo "<ul>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=m&year=".($year)."&month=".($month-1)."\"><i style=\"color: black;\" class=\"icon-arrow-left\"></i></a></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=m\"><i style=\"color: black;\" class=\"icon-circle-blank\"></i></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=m&year=".($year)."&month=".($month+1)."\"><i style=\"color: black;\" class=\"icon-arrow-right\"></i></a></li>";
			echo "</ul>";
			echo "</div>";
//			$this->contentContainerStart();
			...
			$events = $calendar->getEventsInInterval(mktime(0,0,0, $month, 1, $year), mktime(23,59,59, $month, $days, $year));

			echo "<div class=\"row-fluid\">";
			echo "<div class=\"span2\">";
			echo "<h4><a href=\"../out/out.CalendarOld.php?mode=w&year=".($year)."&month=".($month)."&day=1\">".date('W', mktime(12, 0, 0, $month, 1, $year)).". ".getMLText('calendar_week')."</a></h4>";
			echo "<div class=\"well\">";
			...
			for ($i=1; $i<=$days; $i++){
				...
				if (($date["wday"]==$this->firstdayofweek) && ($i!=1)) {
					...
					echo "</div>";
					echo "<div class=\"span2\">";
					echo "<h4><a href=\"../out/out.CalendarOld.php?mode=w&year=".($year)."&month=".($month)."&day=".($i)."\">".date('W', mktime(12, 0, 0, $month, $i, $year)).". ".getMLText('calendar_week')."</a></h4>";
					echo "<div class=\"well\">";
				}
...
//			$this->contentContainerEnd();
			...
			$today = getdate(time());
			$events = $calendar->getEventsInInterval($starttime,$stoptime);

			$this->contentHeading(getMLText("week_view").": ".getReadableDate(mktime(12, 0, 0, $month, $day, $year)));

			echo "<div class=\"pagination pagination-small\">";
			echo "<ul>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=w&year=".($year)."&month=".($month)."&day=".($day-7)."\"><i style=\"color: black;\" class=\"icon-arrow-left\"></i></a></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=w\"><i style=\"color: black;\" class=\"icon-circle-blank\"></i></a></li>";
			print "<li><a href=\"../out/out.CalendarOld.php?mode=w&year=".($year)."&month=".($month)."&day=".($day+7)."\"><i style=\"color: black;\" class=\"icon-arrow-right\"></i></a></li>";
			echo "</ul>";
			echo "</div>";
//			$this->contentContainerStart();
